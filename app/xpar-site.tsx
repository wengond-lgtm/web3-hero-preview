...
const downloads = [
  { type: "Datasheet", name: "X-200_User Documentation_ V1.0_202604", size: "234 KB", href: "/X-200_User Documentation_ V1.0_202604.pdf" },
...
function SupportDownloadsSection() {
  ...
  return (
    <section className="section section-tight">
      <div className="container">
        <Reveal><h2 style={{ fontSize: "clamp(32px, 4.5vw, 52px)", fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-1.5px", marginBottom: "16px" }}>Download <GradientText className="grad-cyan">Center</GradientText></h2></Reveal>
